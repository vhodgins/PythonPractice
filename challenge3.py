string1 = '''kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT
...
for x in range(0, len(list1)):
    s =''
    if list1[x-1].islower():
        if list1[x].isupper():
            if list1[x+1].isupper():
                if list1[x + 2].isupper():
                    if list1[x+3].islower():
                        if list1[x+4].isupper():
                            if list1[x + 5].isupper():
                                if list1[x + 6].isupper():
                                    if list1[x + 7].islower():
